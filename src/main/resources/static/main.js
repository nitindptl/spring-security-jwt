...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.API_URL = 'http://localhost:8090';
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.authenticate = function (credentials, callback) {
        ...
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](credentials ? {
            authorization: 'Barier ' + btoa(credentials.username + ':' + credentials.password),
            'Access-Control-Allow-Origin': '*',
        } : {});
        this.http.post(_app_component__WEBPACK_IMPORTED_MODULE_1__["AppComponent"].API_URL + '/auth/login', credentials, { headers: headers })
...
module.exports = __webpack_require__(/*! D:\Angular Apps\login-app\src\main.ts */"./src/main.ts");
